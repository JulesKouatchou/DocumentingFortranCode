...
[Sample document generated by Doxygen](https://cdslaborg.github.io/paramonte-kernel-doc/html/index.html)
...
### Known Limitations of Each Tool
...
- FORD
    ...
    - Does not recognise implicit types. Another good reason to use `implicit none` in your code
